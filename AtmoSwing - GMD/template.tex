...
\begin{figure*}[t]
	\includegraphics[width=12cm]{figures/fig_01.pdf}
	\caption{Performance score (CRPSS; Eq. \ref{eq:CRPSS}; the reference being the climatological precipitation distribution) of the 30 best variables from the NCEP/NCAR reanalysis dataset, when considered separately (no combination), for the Chablais region and the southeast ridges. The analogy criterion is S1 when there is an asterisk next to the variable name, and RMSE otherwise. Colour illustrates the variable type: green = atmospheric circulation, blue = moisture, orange = temperature, yellow = radiation, purple = vertical velocity, and gray = other. SLP stands for sea level pressure and Z for geopotential height. The blue square indicates the Binn station, which is analyzed in more detail later on.} 
	\label{figure:variable_exploration}
\end{figure*}

\begin{figure}[t]
	\includegraphics[width=8.3cm]{figures/fig_02.pdf}
...
\begin{figure}[t]
	\includegraphics[width=8.3cm]{figures/fig_08.png}
...
\begin{figure*}[t]
	\includegraphics[width=13cm]{figures/fig_11.pdf}
...
\begin{figure*}[t]
	\includegraphics[width=13cm]{figures/fig_12.pdf}
...
\begin{figure*}[t]
	\includegraphics[width=\textwidth]{figures/fig_13.pdf}
