...
%TODO: + help in figures MonteCalro
%TODO: skill / performance ?
%TODO: VALUE?
...
\begin{figure*}[t]
	\includegraphics[width=11cm]{figures/fig_01.pdf}
	\caption{Performance score (CRPSS; Eq. \ref{eq:CRPSS}; the reference being the climatological precipitation distribution) of the 30 best variables from the NCEP/NCAR reanalysis dataset, when considered separately (no combination), for the Chablais region and the southeast ridges. The analogy criterion is S1 when an asterisk is present next to the variable name, and RMSE otherwise. Colour illustrates the variable type: green = atmospheric circulation, blue = moisture, orange = temperature, yellow = radiation, purple = vertical velocity, and gray = other. SLP stands for sea level pressure and Z for geopotential height. The blue square indicates the Binn station.} 
	\label{figure:variable_exploration}
\end{figure*}

\begin{figure}[t]
	\includegraphics[width=7.8cm]{figures/fig_02.pdf}
...
\begin{figure}[t]
	\includegraphics[width=8.3cm]{figures/fig_03.pdf}
...
\begin{figure}[t]
	\includegraphics[width=8.3cm]{figures/fig_06.png}
...
\begin{figure}[t]
	\includegraphics[width=8.3cm]{figures/fig_07.png}
...
\begin{figure*}[t]
	\includegraphics[width=14cm]{figures/fig_10.pdf}
...
\begin{figure*}[t]
	\includegraphics[width=14cm]{figures/fig_11.pdf}
