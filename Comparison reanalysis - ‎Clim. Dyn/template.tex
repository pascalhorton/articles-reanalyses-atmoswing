...
\begin{document}
	...
	All calculations were performed with the open source AtmoSwing software v1.5.0 \citep{Horton2017a}. The resulting files were processed using AtmoSwing R-toolbox v1.0.0 \citep{Horton2017d}.
