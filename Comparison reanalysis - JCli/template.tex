...
\todo{plot 1 event ? 20CR vs MERRA-2}
\todo{Rule of thumb: Newer datasets better ?}
\todo{Results seem proportional to the dataset quality}
\todo{Might be valuable also out of the AMs: comparison of quality ?}
\todo{Other criteria for choice: same model between forecast and reanalysis}
